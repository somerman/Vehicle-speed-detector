class SpeedFileUtils(object):
    ...
    def _filesToDelete(self,mediaDirPath, extension=image_format):
    ...
    def saveRecent(self,recentMax, recentDir, filename, prefix):
        ...
        sfu.deleteOldFiles(recentMax, os.path.abspath(recentDir), prefix)
    ...
    def _freeSpaceUpTo(self,freeMB, mediaDir, extension=image_format):
        """
